...
namespace Data.Migrations
{
    ...
    public partial class SeedingDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "id", "Status", "isShowOnHome", "parentId", "sortOrder" },
                values: new object[,]
                {
                    { 1, 1, true, null, 1 },
                    { 2, 1, true, null, 2 }
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 9, 8, 14, 15, 47, 163, DateTimeKind.Local).AddTicks(5848), 100000m, 200000m, "Áo sơ mi nam trắng Việt Tiến" });

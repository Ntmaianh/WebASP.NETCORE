...
{
    // Lớp này để đổ dữ liệu vào Data bằng thuộc tính HasData
    // Sau khi đổ dữ liệu xong => sang bên lớp DBcontext gọi đến phương thức Seed để đổ dữ liệu vào
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
               ...
               stock = 0,
               viewCount = 0,
               seoAlias = "Áo sơ mi nam trắng Việt Tiến"
           });
           ...
           // any guid;
            ...
            // tạo ra guid : chọn tools => Create Guid
